...
struct VehicleEventHandler
{
	...
	virtual bool onVehicleTrailerAttach(IPlayer& player, IVehicle& vehicle, IVehicle& trailer) { return true; }
	virtual bool onVehicleTrailerDetach(IPlayer& player, IVehicle& vehicle, IVehicle& trailer) { return true; }
};
